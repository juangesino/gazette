...
App.appendToConfig('<platform name="android"><config-file target="AndroidManifest.xml" parent="./application/activity/[@android:name=\'MainActivity\']"><intent-filter android:label="@string/launcher_name" xmlns:android="http://schemas.android.com/apk/res/android"><action android:name="android.intent.action.MAIN" xmlns:android="http://schemas.android.com/apk/res/android" /><category android:name="android.intent.category.LAUNCHER" xmlns:android="http://schemas.android.com/apk/res/android" /></intent-filter><intent-filter android:label="custom_1" xmlns:android="http://schemas.android.com/apk/res/android"><action android:name="android.intent.action.SEND" xmlns:android="http://schemas.android.com/apk/res/android" /><category android:name="android.intent.category.DEFAULT" xmlns:android="http://schemas.android.com/apk/res/android" /><data android:mimeType="text/*" xmlns:android="http://schemas.android.com/apk/res/android" /></intent-filter></config-file></platform>');
